...
const StatCard = ({ title, subtitle, children }) => (
  <div className="flex flex-col items-center bg-white/60 backdrop-blur-md p-4 rounded-xl shadow-md w-40">
...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-100 via-white to-blue-50 py-12">
      <div className="max-w-3xl mx-auto p-8 bg-white/60 backdrop-blur-md rounded-3xl border border-gray-200 shadow-lg">
        <h2 className="text-3xl font-extrabold mb-6">ABOUT</h2>

        <section className="mb-6">
          <h3 className="text-lg font-bold">GDG ON CAMPUS – MACE</h3>
        ...
        <section className="mb-6">
          <h3 className="text-lg font-bold">LUMORA</h3>
          <p className="mt-2 text-sm text-gray-700">
            LUMORA is a two-day design-focused hackathon organized by GDG
        ...
        <section className="mb-8">
          <h4 className="text-center font-bold mb-6">PARTICIPATION DETAILS</h4>
        ...
        <section className="mb-6">
          <h4 className="font-bold mb-2">SHORTLISTING PROCESS</h4>
